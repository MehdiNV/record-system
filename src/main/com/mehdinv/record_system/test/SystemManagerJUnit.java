...
import main.com.mehdinv.record_system.students.PGTaughtStudent;
import main.com.mehdinv.record_system.student_identifiers.SmartCards;
import main.com.mehdinv.record_system.students.Student;
import main.com.mehdinv.record_system.student_identifiers.StudentID;
...
public class SystemManagerJUnit {
	...
	public void noOfStudentsTest() throws Exception {
		//JUnit main.com.mehdinv.record_system.test that checks if noOfStudents is correctly returning the right number of students correctly
		...
		//Runs the first main.com.mehdinv.record_system.test on the noOFStudents
		//In this main.com.mehdinv.record_system.test, we expect to see 0 students registered as undergraduates, since no one has been registered yet
		
		//TEST NUMBER TWO:
		assertEquals(0,system.noOfStudents(TypeOfStudent.PGT));
		//Runs the second main.com.mehdinv.record_system.test on the noOFStudents
		...
		//In this main.com.mehdinv.record_system.test, we expect to see 0 students registered as PGT, since no one has been registered yet
		
		//TEST NUMBER THREE:
		assertEquals(0,system.noOfStudents(TypeOfStudent.PGR));
		//Runs the third main.com.mehdinv.record_system.test on the noOFStudents
		//In this main.com.mehdinv.record_system.test, we expect to see 0 students registered as PGR, since no one has been registered yet
		
		//For main.com.mehdinv.record_system.test number 4, we'll create a new student and register them, to increase the the number of students
		...
		//For main.com.mehdinv.record_system.test number 5, we'll create a new student and register them, to increase the the number of students
	...
	public void amendStudentData () throws Exception {
		...
		//These two tests below should main.com.mehdinv.record_system.test if the new object (AnnaDavidson) has the same ID & smart card number as AnnaDavid object
